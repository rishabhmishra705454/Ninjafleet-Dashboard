...
import MapPicker from "@/app/dashboard/providers/[id]/add/map-picker";
import {
  Select,
  SelectItem,
  SelectTrigger,
...
import { addMachineryByProvider, getMachineryById, Machinery } from "@/app/api/machinery";
...
export default async function Page({ params }: { params: { machineryId: string } }) {
